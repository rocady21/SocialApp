...
export const useUserSlice = ()=> {
    ...
    const LoginUser = async(datos)=> {
        try {
            const {data} = await axios.post(`https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/login`,{
    ...
    const validToken = async (tk)=> {
        ...
        try {
            ...
            const {data} = await axios.get("https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/validToken",{
    ...
    const FollowUser = async(info)=> {
        try {
            const {data} = await axios.post("https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/send_request_friend",info)
            if(data.ok === true){
                Dispach(onFollow())
            } 
        } catch (error) {
    ...
    const UnfollowUser = async(info)=> {
        try {
            const {data} = await axios.delete(`https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/reject_request_friend?param1=${info.id_user_seguidor}&param2=${info.id_user_seguido}`)
            if(data.ok === true ) {
                Dispach(onUnFollow())
            }
        } catch (error) {
    ...
    const SearchUser = async(value)=> {
        try {
            ...
            const {data} = await axios.get(`https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/user/${value}`)    
            if(data.ok == true) {
    ...
    const loadInfoUserById = async(id)=> {
        ...
        try {
            const {data} = await axios.post(`https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/people/${id}`,{
    ...
    const LoadFriendRequest = async()=>{
        try {
            const {data} = await axios.get("https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/request_friends/" + user.id)
            if(data.ok === true) {
    ...
    const AcceptFriendRequest = async(info)=> {
        try {
            const {data} = await axios.put("https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/accept_request_friend",info)
    ...
    const LoadFollowers = async()=> {
        try {
            const {data} = await axios.get("https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/follower/" + user.id)
    ...
    const LoadFollowings = async()=> {
        try {
            const {data} = await axios.get("https://33d3-2800-a4-125d-c500-a92f-a808-838d-e92c.ngrok-free.app/api/following/" +  user.id)
            if(data.ok === true) {
                Dispach(onLoadFollowersorFollowings(data.amigos))
